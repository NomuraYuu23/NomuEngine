...
void RootParameterManager::Initialize()
{
	...
	// 布
	RootParameterInitializeForCloth();
...
void RootParameterManager::RootParameterInitializeForCloth()
{
	...
	for (uint32_t i = 0; i < _countof(rootParameters); ++i) {
		rootParameters_[kRootParameterIndexCloth].push_back(rootParameters[i]);
	}
