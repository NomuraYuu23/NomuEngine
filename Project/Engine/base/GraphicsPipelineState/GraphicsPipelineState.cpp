...
void GraphicsPipelineState::CreateForCloth()
{

	CreatePSODesc createPSODesc;

	RootsignatureSetting(
		kPipelineStateNameCloth,
		D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT,
		kRootParameterIndexCloth,
		kSamplerIndexNormal);

	createPSODesc.pipelineStateName = kPipelineStateNameCloth;
	...
	createPSODesc.vertexShaderBlob = CompileShader::Compile(L"Resources/shaders/Cloth.VS.hlsl",
		L"vs_6_0");
	createPSODesc.pixelShaderBlob = CompileShader::Compile(L"Resources/shaders/Cloth.PS.hlsl",
		L"ps_6_0");
