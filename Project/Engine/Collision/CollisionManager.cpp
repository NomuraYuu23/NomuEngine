...
void CollisionManager::Initialize()
{
	...
	octreeManager_ = std::make_unique<OctreeManager>();
	octreeManager_->Initialize();
...
{
	octreeManager_->ListClear();
}

void CollisionManager::ListRegister(ColliderShape* collider)
{

	octreeManager_->ListRegister(collider);
...
void CollisionManager::CheakAllCollision()
{
	...
	octreeManager_->CollisionSystem();
